...
?>
<div id="payment" class="col-sm-8 woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		...
		echo "
		<div class='product-q' id='place_order'>
		<a href='#' class='checkout-btn'  data-value='" . esc_attr( $order_button_text ) . "'>
			Place Order
		</a>
		</div>";
		?>
